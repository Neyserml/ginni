import { getData, getFailed, getLoading, INITIAL_STATE, reducer } from './ingresos.reducer';
import { LoadAction, LoadFailAction, LoadSuccessAction } from './ingresos.action';
...
describe('Ingresos', () => {
  describe('Reducer', () => {
    ...
    describe('[Ingresos] Load Success', () => {
