import {
  ...
  INITIAL_STATE,
  reducer
} from './contrato-programacion.reducer';
import { LoadAction, LoadFailAction, LoadSuccessAction } from './contrato-programacion.action';
...
describe('ContratoProgramacion', () => {
  describe('Reducer', () => {
    ...
    describe('[Contrato Programacion] Load', () => {
      it('should load', () => {
        const actionState = {
          token: 'ef4654da5c1d5',
          contrasenia: '123456'
    ...
    describe('[Contrato Programacion] Load Fail', () => {
      it('should load fail', () => {
    ...
    describe('[Contrato Programacion] Load Success', () => {
